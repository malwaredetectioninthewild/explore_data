...
* **ReadMetadata.ipynb**: We explore the metadata stored in **train_metadata.pkl**, demonstrates how to obtain ground truth labels, family labels and publisher labels (along with the labeling timestamps) from our metadata.
...
Once you download the datasets, extract the **metadata.zip** to create **train_hashes.pkl** and **train_metadata.pkl** files under the **metadata** directory; and extract **sandbox_train.zip** to create our sandbox training datasets under **sandbox_train** directory.
