...
Once you download the datasets, extract the **metadata.zip** to create **train_test_hashes.pkl** and **hash_metadata.pkl** files under the **metadata** directory; and extract **sandbox_datasets.zip** to create our sandbox datasets under **sandbox_datasets** directory.
